...
func IsCreator(from string) bool {
...
func IsStaff(from string) bool {
	if InArray(service.Admins, from) == true {
		return true
	}
	return false
}

func IsAllStaff(from string) bool {
	if InArray(service.Creator, from) == true || InArray(service.Admins, from) == true{
		return true
	}
	return false
}
...
func IsAccess(from string) bool {
	if InArray(service.Creator, from) == true || InArray(service.Admins, from) == true || InArray(service.Squad, from) == true || InArray(service.Bots, from) == true{
		return true
	}
	return false
}
...
func IsBots(from string) bool {
	if InArray(service.Bots, from) == true {
		return true
	}
	return false
}
