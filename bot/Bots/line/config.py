...
class Config(object):
    ...
    def __init__(self, appType=None):
        ...
        #self.APP_NAME = 'ANDROID 7.5.2 Android OS 5.1'
        #self.USER_AGENT = 'Line/7.5.2'
        self.APP_NAME = 'IOS 8.9.0 iPhone OS 1'
        self.USER_AGENT = 'Line/2017.0731.2132 CFNetwork/758.6 Darwin/15.0.0'
